...
Begin VB.Form frmManPCs 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantenimiento de PCs"
   ClientHeight    =   5925
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8970
   Icon            =   "frmManPCs.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5925
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   2
      Tag             =   "Descripción|T|S|||pcs|descripcion|||"
      Top             =   4945
      Width           =   945
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Id.PC|N|N|0|9999|pcs|idpcs|0000|S|"
      Top             =   4945
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManPCs.frx":000C
      Height          =   4410
      Left            =   90
      TabIndex        =   7
      Top             =   540
...
'    CadB = ""
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("pcs", "idpcs")
    End If
    '********************************************************************
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar el PC?"
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from pcs where idpcs=" & adodc1.Recordset!idpcs
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "idpcs=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT pcs.idpcs, pcs.nompc, pcs.descripcion "
    CadenaConsulta = CadenaConsulta & " FROM pcs "
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(1)|T|Nombre|3750|;"
    tots = tots & "S|txtAux(2)|T|Descripcion|3750|;"
