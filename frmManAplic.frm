...
Begin VB.Form frmManAplic 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   5
      Tag             =   "Ejecutable|T|N|||aplicaciones|ejecutable|||"
      Top             =   4950
      Width           =   945
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   100
      TabIndex        =   4
      Tag             =   "Path Servidor|T|N|||aplicaciones|pathservidor|||"
      Top             =   4945
      Width           =   720
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   3
      Tag             =   "Servidor|T|N|||aplicaciones|servidor|||"
      Top             =   4945
      Width           =   1170
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Nombre Aplicacion|T|N|||aplicaciones|nombre|||"
      Top             =   4945
      Width           =   1215
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   20
      TabIndex        =   2
      Tag             =   "Ultima Version|T|N|||aplicaciones|ultimaversion|||"
      Top             =   4945
      Width           =   945
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Id.Aplicacion|N|N|0|9999|aplicaciones|idaplicacion|0000|S|"
      Top             =   4945
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManAplic.frx":000C
      Height          =   4410
      Left            =   120
      TabIndex        =   10
      Top             =   540
   ...
   Begin VB.Label Label1 
      Caption         =   "Version 4.1.0.15  --- >   El tercer valor no cuenta. Es NUESTRA 4.1.15"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
'    CadB = ""
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("aplicaciones", "idaplicacion")
    End If
    '********************************************************************
...
Private Sub BotonBuscar()
    ...
    CargaGrid "aplicaciones.idaplicacion = -1"
    '*******************************************************************************
    'Buscar
    For i = 0 To txtAux.Count - 1
        txtAux(i).Text = ""
...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = "¿Seguro que desea eliminar la Aplicación?"
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from aplicaciones where idaplicacion=" & adodc1.Recordset!idaplicacion
        conn.Execute SQL
        CargaGrid CadB
'        If CadB <> "" Then
'            CargaGrid CadB
...
Private Sub cmdAceptar_Click()
    ...
    txtAux(4).Text = Replace(txtAux(4).Text, "\", "\\")
        ...
        Else
            PonerModo 2
             If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "idaplicacion=" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "SELECT aplicaciones.idaplicacion, aplicaciones.nombre, aplicaciones.ultimaversion, aplicaciones.servidor, "
    CadenaConsulta = CadenaConsulta & "aplicaciones.pathservidor, aplicaciones.ejecutable "
    CadenaConsulta = CadenaConsulta & " FROM aplicaciones"
...
'    adodc1.ConnectionString = Conn
    ...
    '********************* canviar el ORDER BY *********************++
    SQL = SQL & " ORDER BY aplicaciones.idaplicacion"
    '**************************************************************++
    ...
    tots = tots & "S|txtAux(1)|T|Nombre|2500|;"
    tots = tots & "S|txtAux(2)|T|Ultima Versión|1500|;"
    tots = tots & "S|txtAux(3)|T|Servidor|1000|;S|txtAux(4)|T|Path Servidor|3200|;"
    tots = tots & "S|txtAux(5)|T|Ejecutable|1200|;"
...
'        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomEmpre & "'|pOrden={aplicaciones.idaplicacion}|"
