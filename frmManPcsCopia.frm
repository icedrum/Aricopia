...
'    If Not SepuedeBorrar Then Exit Sub
    ...
    SQL = SQL & vbCrLf & "Aplicación:    " & adodc1.Recordset.Fields(2) & " - " & adodc1.Recordset.Fields(3)
...
'    adodc1.ConnectionString = Conn
    ...
    tots = tots & "S|txtAux(1)|T|App.|700|;S|btnBuscar(1)|B|||;S|txtAux2(1)|T|Descripción|1900|;"
...
'            PonerFormatoEntero txtAux(Index)
        ...
        Case 1 'codigo de aplicacion
            ...
            If txtAux2(Index).Text = "" Then
                cadMen = "No existe la Aplicación : " & txtAux(Index).Text & vbCrLf
